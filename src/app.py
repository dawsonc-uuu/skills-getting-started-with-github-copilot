...
activities = {
    ...
    "Volleyball Club": {
        "description": "Indoor volleyball instruction and recreational play",
        "schedule": "Tuesdays and Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["amelia@mergington.edu"]
    },
    "Theatre Club": {
        "description": "Act in plays and musicals, perform on stage",
        "schedule": "Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 25,
        "participants": ["grace@mergington.edu", "harper@mergington.edu"]
    },
    "Photography Club": {
        "description": "Learn photography techniques and exhibit photos",
    ...
    "Robotics Club": {
        ...
        "max_participants": 14,
        "participants": ["logan@mergington.edu", "ryan@mergington.edu"]
    },
    "Mathlete Club": {
        "description": "Compete in mathematics competitions and solve challenging problems",
